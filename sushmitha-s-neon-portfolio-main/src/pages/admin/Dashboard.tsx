          ...
          {activeTab === "profile" && (
            <div className="glass-card p-6 space-y-4">
              <div>
                ...
                <input type="text" className="w-full bg-background/50 border border-primary/20 rounded p-2" value={String(profile.name || "")} onChange={e => setProfile({...profile, name: e.target.value})} />
              </div>
              <div>
                <label className="block text-sm mb-1">Roles (comma separated)</label>
                <input type="text" className="w-full bg-background/50 border border-primary/20 rounded p-2" value={String(profile.role || "")} onChange={e => setProfile({...profile, role: e.target.value})} />
              </div>
              <div>
                <label className="block text-sm mb-1">About</label>
                <textarea rows={5} className="w-full bg-background/50 border border-primary/20 rounded p-2" value={String(profile.about || "")} onChange={e => setProfile({...profile, about: e.target.value})} />
              </div>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                {skills.map(skill => (
                  <div key={skill.id} className="glass-card p-4 space-y-3">
                    <input className="w-full bg-background/50 border border-primary/20 rounded p-2 text-sm" value={String(skill.name || "")} onChange={(e) => updateListItem("skills", skill.id, { name: e.target.value })} placeholder="Skill Name" />
                    <input className="w-full bg-background/50 border border-primary/20 rounded p-2 text-sm" value={String(skill.level || "")} onChange={(e) => updateListItem("skills", skill.id, { level: e.target.value })} placeholder="Level/Category" />
                ...
                {projects.map(proj => (
                  <div key={proj.id} className="glass-card p-4 space-y-3">
                    <div className="grid sm:grid-cols-2 gap-3">
                      <input className="bg-background/50 border border-primary/20 rounded p-2 text-sm" value={String(proj.title || "")} onChange={(e) => updateListItem("projects", proj.id, { title: e.target.value })} placeholder="Title" />
                      <input className="bg-background/50 border border-primary/20 rounded p-2 text-sm" value={String(proj.subtitle || "")} onChange={(e) => updateListItem("projects", proj.id, { subtitle: e.target.value })} placeholder="Subtitle (e.g., E-Commerce)" />
                    </div>
                    <textarea rows={3} className="w-full bg-background/50 border border-primary/20 rounded p-2 text-sm" value={String(proj.description || "")} onChange={(e) => updateListItem("projects", proj.id, { description: e.target.value })} placeholder="Description" />
                    <input className="w-full bg-background/50 border border-primary/20 rounded p-2 text-sm" value={String(proj.tech || "")} onChange={(e) => updateListItem("projects", proj.id, { tech: e.target.value })} placeholder="Tech stack (comma separated)" />
                    <div className="grid sm:grid-cols-2 gap-3">
                       <input className="bg-background/50 border border-primary/20 rounded p-2 text-sm" value={String(proj.github || "")} onChange={(e) => updateListItem("projects", proj.id, { github: e.target.value })} placeholder="GitHub Link" />
                       <input className="bg-background/50 border border-primary/20 rounded p-2 text-sm" value={String(proj.demo || "")} onChange={(e) => updateListItem("projects", proj.id, { demo: e.target.value })} placeholder="Live Demo Link" />
                    </div>
              ...
              <div className="space-y-4">
                {achievements.map(item => (
                  <div key={item.id} className="glass-card p-4 space-y-3">
                    <div className="grid sm:grid-cols-2 gap-3">
                       <input className="bg-background/50 border border-primary/20 rounded p-2 text-sm" value={String(item.title || "")} onChange={(e) => updateListItem("achievements", item.id, { title: e.target.value })} placeholder="Title (e.g. BCA, Certification Name)" />
                       <input className="bg-background/50 border border-primary/20 rounded p-2 text-sm" value={String(item.subtitle || "")} onChange={(e) => updateListItem("achievements", item.id, { subtitle: e.target.value })} placeholder="Subtitle (Institution / Body)" />
                    </div>
                    <div className="grid sm:grid-cols-2 gap-3">
                       <input className="bg-background/50 border border-primary/20 rounded p-2 text-sm" value={String(item.year || "")} onChange={(e) => updateListItem("achievements", item.id, { year: e.target.value })} placeholder="Year / Duration" />
                       <select className="bg-background/50 border border-primary/20 rounded p-2 text-sm" value={String(item.type || "education")} onChange={(e) => updateListItem("achievements", item.id, { type: e.target.value })}>
          ...
          {activeTab === "contact" && (
            <div className="glass-card p-6 space-y-4">
              <div>
                ...
                <input type="email" className="w-full bg-background/50 border border-primary/20 rounded p-2" value={String(contact.email || "")} onChange={e => setContact({...contact, email: e.target.value})} />
              </div>
              <div>
                <label className="block text-sm mb-1">Phone</label>
                <input type="text" className="w-full bg-background/50 border border-primary/20 rounded p-2" value={String(contact.phone || "")} onChange={e => setContact({...contact, phone: e.target.value})} />
              </div>
              <div>
                <label className="block text-sm mb-1">LinkedIn URL</label>
                <input type="url" className="w-full bg-background/50 border border-primary/20 rounded p-2" value={String(contact.linkedin || "")} onChange={e => setContact({...contact, linkedin: e.target.value})} />
              </div>
               <div>
                <label className="block text-sm mb-1">GitHub URL (Optional)</label>
                <input type="url" className="w-full bg-background/50 border border-primary/20 rounded p-2" value={String(contact.github || "")} onChange={e => setContact({...contact, github: e.target.value})} />
              </div>
